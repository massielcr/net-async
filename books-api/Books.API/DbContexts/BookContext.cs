...
public class BooksDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Book>().HasData(
           new Book
           (
                Guid.Parse("5b1c2b4d-48c7-402a-80c3-cc796ad49c6b"),
           ...
           new Book
           (
                Guid.Parse("d8663e5e-7494-4f81-8739-6e0de1bea7ee"),
                Guid.Parse("d28888e9-2ba9-473a-a40f-e38cb54f9b35"),
                "A Game of Thrones",
           ...
           new Book
           (
                Guid.Parse("d173e20d-159e-4127-9ce9-b0ac2564ad97"),
           ...
           new Book
           (
                Guid.Parse("493c3228-3444-4a49-9cc0-e8532edc59b2"),
           ...
           new Book
           (
               Guid.Parse("40ff5488-fdab-45b5-bc3a-14302d59869a"),
